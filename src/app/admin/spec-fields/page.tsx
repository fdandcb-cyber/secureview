  ...
  return (
    <div className="space-y-6">
      ...
      <DataTable
        ...
        data={fields}
        columns={[
          { header: "Category", accessorKey: "category", cell: (r) => <Badge tone="primary">{r.category}</Badge> },
          { header: "Key", accessorKey: "key", cell: (r) => <span className="font-mono text-xs text-slate-950 font-bold">{r.key}</span> },
          ...
          { header: "Type", accessorKey: "type", cell: (r) => <Badge tone="neutral">{r.type}</Badge> },
        ]}
      />
    </div>
  );
